						...
						<div id="is-login" class="top-loginbar fl">
							<c:choose>
								<c:when test="${not empty user}">
									<a href="user.jsp"><span id="user_name"
										class="fl top-loginbar-username">欢迎你，${user.userName}</span></a>
								</c:when>
								<c:otherwise>
									<a
										href="userloginOut?continueUrl=storeview?store_id=${store.storeID}"><span
...
<input id="storeids" type="hidden" value="${store.storeID}">
				...
				<div class="middlenav-wrap clearfix">
					...
					<form action="storesearch">
						<div class="search-box fr">
							...
							<input style="padding-left: 30px;" name="adress" type="text" class="header-search"
	...
	<div class="page-wrap">
		<div class="inner-wrap">
			...
			<div class="breadcrumb">
				<a class="ca-brown" href="#">${store.storename}</a><i>&gt;</i><span>确认购买</span>
				
				<input type="hidden" class="start_price"
					value="${store.startPrice}" />
			</div>
				...
				<div class="order-info-wrapper j-order-info-wrapper clearfix">
								...
								<tr class="delivery" data-total="126">
									<td colspan="3" class="clearfix middle">
										<div class="td-inner clearfix">
											<span class="d-total fl">配送费(不计入起送价)</span> <span
												class="d-number fr">¥<span>${store.expressFree}</span></span>
										</div>
									</td>
								</tr>
									...
									<tr class="delivery" data-total="126">
										<td colspan="3" class="clearfix middle">
											<div class="td-inner clearfix">
												...
												<span class="d-total fl">${clist.menu.menuName}</span> 
												<span class="d-number fr" style="width:70px;color: red;">单价:${clist.price}</span>
												<br /> 
												<span class="d-number fr" style="width:70px;">数量:${clist.amount}</span>
											</div>
										</td>
									</tr>
								</c:forEach>
						...
						<div class="privilege">
							<div class="operation clearfix">
								<div class="fr si-input">
									<input type="text" class="pri-input sprite" id="privilegeInput"
										value="选择优惠券" data-cid="0" readonly> <a
										href="javascript:;" class="drop" id="dropTicket"><i
										class="icon i-triangle-dn"></i></a>
					...
					<div class="dishes">
						<div class="dishes-rap">
							...
							<form action="" id="orderForm" class="order-form">
								<div id="address-list" class="address-list">
									<div id="address-new" class="address-box-empty"
										data-newuser="1">
										<i class="order-icon i-add-addr"></i>添加新地址
									</div>
									<div id="inputform">
										<div>
											联系人：<input type="text" name="receiver_name" value=""
												style="margin-left:12px;">
										</div>
										<div>
											手机号码：<input type="text" name="phone" value="">
										</div>
										<div>
											收货地址： <input type="text" name="province" value=""
												style="width:50px;">省 <input type="text" name="city"
												value="" style="width:50px;">市 <input type="text"
												name="district" value="" style="width:50px;">区 <input
												type="text" name="street" value="" style="width:200px;">
								...
								<input type="hidden" name="poiid" value="94801"> <input
									type="hidden" name="token"
									value="2EB29E51FFF14C97B18B35DB2377EB3A"> <input
									type="hidden" name="buildingid" value="">

								<div class="field clearfix leave-message">
									<label for="message">给商家留言：</label> <input
										class="show-tags sprite" type="text" name="message"
										placeholder="不要辣，多放盐等口味要求" maxlength="100" value=""> <input
								...
								<div class="pay-field clearfix">
									...
									<div class="fl pay-option clearfix">
										<a href="javascript:;" data-method="1"
											class="fl sprite option  ">餐到付款</a> <a href="javascript:;"
											data-method="2"
											class="fl sprite option option-margin selected ">在线支付</a>
									</div>
								</div>
							</form>
						...
						<div class="pre-order field">
							<span>期望送达时间：</span> <a href="javascript:;" id="preorder-time"
								class="select-input"><span>立即送出</span><i class="icon"></i></a> <span
								class="pre-order-tip"><span class="error-tips"></span></span>
						</div>

						<div class="pay-area">
							<div id="order-address-warning" class="order-address-warning"
							...
							<a class="s-btn yellow-btn fr" id="confirmOrder"><span
								class="s-btn">完成付款</span></a>
							<div class="tips ct-black">
								您需支付&nbsp;<span class="price cc-lightred-new">¥<span
									id="totalPrice">${totalPrice}</span> <span
									class="nodiscount-tip borderradius-2"> 您今日优惠已用完，本单不再享受优惠
										<i class="icon i-discountip"></i>
								</span> <span class="nodiscount-tip borderradius-2"> 您今日优惠已用完，使用<a
										href="/mobile/download/bonus_limited" target="_blank">手机客户端</a>可享更多优惠
										<i class="icon i-discountip"></i>
								</span>
								</span> <span id="endfix" class="ct-black hidden">，饭到当面付款</span><br>
	...
	<div class="page-footer">
		<div class="footer-wrap">
			...
			<div class="column fl update">
				...
				<ul>
					...
					<li><a href="http://e.weibo.com/u/3949575070"
						class="ca-darkgrey" target="_blank" rel="nofollow">美团外卖新浪微博</a></li>
			...
			<div class="column fl info">
				...
				<ul>
					<li><a href="http://www.meituan.com/about/"
						class="ca-darkgrey" target="_blank" rel="nofollow">关于美团</a></li>
					...
					<li><a href="/help/rule" class="ca-darkgrey" target="_blank"
						rel="nofollow">美团点评餐饮安全管理办法</a></li>
				</ul>
			</div>
			...
			<div class="sp-ft">
				<a target="_blank" title="备案信息" class="record"></a>
			</div>
		</div>
	</div>
	<!--脚步结束-->
