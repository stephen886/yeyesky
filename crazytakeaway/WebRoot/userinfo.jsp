	...
	<div class="informantion_or3">
		<form action="userupdateinfo" method="post">
			...
			<div class="info_form_img">
				<img style="width:100px;height: 100px;" src="img/logo_left.png"
					class="info_img" /> <input type="button" value="上传头像"
					onclick="path.click()"> <input type="file" id="path"
					style="display:none">
			</div>
			<div class="info_form">
				<span class="info_form_label">真实姓名：</span> <input type="text"
					name="uerInfo.realName" value="${us.uerInfo.realName}">
			</div>

			<div class="info_form1">
				<span class="info_form_label">性别：</span> <label id="info_sex"><input
					type="radio" value="男" name="uerInfo.sex">男</label> <label
					id="info_sex"><input type="radio" value="女"
					name="uerInfo.sex">女</label>
			</div>
