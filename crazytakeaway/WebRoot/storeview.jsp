...
<body>
			...
			<div class="inner-wrap">
				...
				<div class="rest_info">
					<div id="rest_info_left">
						<img style="width: 120px ; height: 90px;" src="img/store_img/${store.storeImg}" />
						<div id="store_blok" class="rest_info_left_title">
							<p class="xianzhiwenzi">${store.storename}</p>
							<p>
							...
							<p style="font-size: 0.5em; color: #737373;">${store.startPrice}元起送
								免费配送 由商家配送</p>
				...
				<div class="save-up-wrapper">
					...
					<input id="collectID" type="hidden" value="${StoreCollectID}" /> <input
						id="storeid" type="hidden" value="${store.storeID}" />
				...
				<div class="food_nav">
					...
					<div class="pic-food-cont">
						...
						<c:forEach items="${store.menulist}" var="menu">
                            ...
                            -->
							<div class="one_food">
								<input type="hidden" class="menu_id" value="${menu.menuID}" />

								<img src="img/menu_img/${menu.menuImg}" />
								<h4>${menu.menuName}</h4>
								<div class="sale-info">
				...
				<div class="widgets">
					...
					<div class="widget discount">
						<p class="delivery-min-fee">
							<span>起送价：</span>${store.startPrice} 元
						</p>
						<p class="delivery-fee">
							<i></i><span class="discount-desc">配送费：${store.expressFree}元</span>
						</p>
						<p>
	...
	<div class="shopping-cart clearfix" data-status="1"
		data-poiname="德客斯披萨" data-poiid="94801">
		<form method="post"
			action="viewStore_OrderAction!viewStore?StoreID=${store.storeID}"
			id="shoppingCartForm">

			<div class="first-to-app clearfix j-first-to-app" style="top: -35px;">
				<span class="fl">电脑下单不享优惠了哦，优惠活动手机专享~</span>

			</div>

			<div class="order-list" style="top: -260px;">
				<div class="title">
					<span class="fl dishes">菜品<a href="javascript:;"
						class="clear-cart">[清空]</a></span> <span class="fl">份数</span> <span
						class="fl ti-price">价格</span>
				</div>
				...
				<div class="other-charge">
					<div class="clearfix packing-cost hidden">
						<span class="fl">包装盒</span> <span class="fr boxtotalprice">¥0</span>
					</div>
					<div class="clearfix delivery-cost">
						<span class="fl">配送费(不计入起送价)</span> <span class="fr shippingfee">¥<span>0</span></span>
					</div>
				</div>
			...
			<div class="footer clearfix">
				<div class="logo icon fl">
					<i class="icon i-shopping-cart-new"></i>
				</div>
				<div class="brief-order fl" style="display: none;">
					<span class="count">22份</span> <span class="price">¥1561</span>
				</div>
				<div class="fr">
					<a class="ready-pay borderradius-2" href="javascript:;"
						style="display: none;">还差<span data-left="39"
						class="margintominprice">0</span>元起送
					</a> <a href="orderpreview?storeid=${store.storeID}"><input class="go-pay borderradius-2" type="button" value="去下单"
						style="display: inline-block;"></a> <input type="hidden"
						value="" class="order-data" name="shop_cart">
				</div>
			</div>
		</form>
	</div>
