...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<c:url value="/admin/addMenu"/>" enctype="multipart/form-data" />  
      ...
      <div class="form-group">
        <div class="label">
          <label>LIMIT_SHOP：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" name="limitShop" value="" data-validate="member:只能为数字"  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
