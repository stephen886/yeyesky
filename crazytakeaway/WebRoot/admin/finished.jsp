  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center unfinished" style="width: 1130px;">
      <tr>
        ...
        <th class="finish_time">完成时间</th>
      </tr>
      <volist name="list" id="vo">
        <c:choose>
      	<c:when test="${not empty finishlist}">
      		<c:forEach items="${finishlist}" var="list">
		        <tr>
		          ...
		          <td>${list.orderTime}</td>
          		  <td>${list.finishedTime}</td>
       		</c:forEach>	
      	</c:when>
      	<c:otherwise>
      	<tr>
      		<td colspan="7" style="height: 100px;">
      			<div class="" style=" font-size: 20px; " >没有已完成订单的记录！</div>
      		</td>
      	</tr>
