		...
		<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="index_field.html">分类板块设置</a>
                            </li>
			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
				...
				<div class="wrapper wrapper-content">
					...
					<form class="form-horizontal container" style="max-width: 600px;">
						<div class="form-group">
							<!-- Select Basic -->
							<label class="col-sm-4 control-label">请选择商品</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<!-- Select Basic -->
							<label class="col-sm-4 control-label">请选择商品的分类</label>
							<div class="col-sm-8">
								<select class="form-control">
								      <option>轮播图片一</option>
								      <option>轮播图片二</option>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">生产地址</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">生产日期</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">保质期天数</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
			...
			<div class="form-group">
				...
				<form class="form-horizontal container" style="max-width: 600px;">
						<div class="form-group">
							<!-- Select Basic -->
							<label class="col-sm-4 control-label">请选择规格</label>
							<div class="col-sm-8">
								<select class="form-control">
								      <option>轮播图片一</option>
								      <option>轮播图片二</option>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">规格单位</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">规格数量</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">规格价格</label>
							<div class="col-sm-8">
								<input type="email" class="form-control" id="inputEmail3">
							</div>
						</div>
						  ...
						  <div class="col-lg-3">
						    <div class="thumbnail">
						      ...
						      <label >图片文件</label>
						        ...
						        <p><a href="#" class="btn btn-primary" role="button">保存</a></p>
						      </div>
						    </div>
						  </div>
