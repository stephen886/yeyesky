			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
				...
				<div class="wrapper wrapper-content">
					...
					<h2>删除商品</h2>
						<div class="form-group">
							<!-- Select Basic -->
							<label class="col-sm-4 control-label">请选商品</label>
							<div class="col-sm-6">
							...
							<button type="submit" class="btn btn-primary col-lg-2">删除</button>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">查找商品</label>
							<div class="col-sm-6">
					...
					<div id="resault" style="display: none;">
					<h2>搜索结果</h2>
					<div class="row">
						  <div class="col-lg-3">
						    <div class="thumbnail">
