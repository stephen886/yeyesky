			...
			<ul>
			  <c:choose> 
		        <c:when test="${not empty sessionScope.user_name}">
		         <li class="login">${sessionScope.user_name}你好<a href="login.html">  注销</a></li>
		        </c:when>
		        <c:otherwise>
		            <li class="login.html"><a href="login.html">登录</a><a href="login.html" id="login.html"> 免费注册</a></li>
		         </c:otherwise>
		       </c:choose>
